...
describe("markdown generation", () => {
  it("creates vrchat-guidebook style steps with images and video", () => {
    ...
    expect(markdown).toContain("![Open project](artifacts/run-1/screenshots/open-project.png)");
    expect(markdown).toContain("[操作動画](artifacts/run-1/video/unity-basic-annotated.mp4)");
  });
});
